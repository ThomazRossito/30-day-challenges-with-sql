...
-- MAGIC %md
-- MAGIC Neste primeiro desafio super fácil, precisamos apenas dos registros do campo `sqlite_db.customer.Email` da tabela Customers onde o domínio seja da `apple`.
