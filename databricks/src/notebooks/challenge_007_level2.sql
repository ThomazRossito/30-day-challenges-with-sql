...
-- MAGIC %md
-- MAGIC Nesse desafio eu preciso que tu crie uma nova tabela chamada Track2 oriunda da transformação das tabelas: Track, Album, Artist e Genre <br>
-- MAGIC lembrando que a tabela que vai mandar no relacionamento é a tabela da esquerda Track aqui tu vai usar JOIN
-- MAGIC 
-- MAGIC Critério:
...
-- MAGIC ```sql
-- MAGIC SELECT * from sqlite_db.track
-- MAGIC ```
